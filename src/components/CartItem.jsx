...
const CartItem = (params) => {
    ...
    const changeCardValue = (change) => {
        cartDispatch({type: CHANGE_CART_AMOUNT, payload: {
            id, title, img: image, price, amount: change
        }})
    }
  ...
  return (
    <div className='cart-item'>
        ...
        <div className='cart-item-amount'>
            <img src={chevLeft} alt='chev-left' onClick={() => changeCardValue(-1)}/>
            <p>{amount}</p>
            <img src={chevRight} alt='chev-right' onClick={() => changeCardValue(1)}/>
