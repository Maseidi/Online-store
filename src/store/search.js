...
export const searchReducer = (state, action) => {
  ...
  else if (action.type === CHANGE_MIN_PRICE)
    return { ...state, minPrice: action.payload.newValue }
  else if (action.type === CHANGE_MAX_PRICE)
    return { ...state, maxPrice: action.payload.newValue }
